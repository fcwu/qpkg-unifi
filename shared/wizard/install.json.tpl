{
  ...
  "binding": {
    ...
    "data": {
      "iface": "networks.unifi.ipam.driver_opts.iface",
      "ipv4_addr": "services.unifi.networks.unifi.ipv4_address",
      "subnet": "networks.unifi.ipam.config[0].subnet",
      "gateway": "networks.unifi.ipam.config[0].gateway"
    },
    "template": ["*.tpl"]
  }
}
